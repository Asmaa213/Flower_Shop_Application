...
<head>
   ...
   <title>Flower Mas website</title>
...
<header class="header">
    ...
    <a href="#" class="logo">MasForU<span>.</span></a>
    <div class="flex">
        <nav class="navbar">
            <ul>
                ...
                <li><a href="#">SHOP +</a>
                    <ul>
                        ...
                        <li><a href="index.php#Bouquet">Bouquet</a></li>
                        <li><a href="index.php#flowers">Flowers</a></li>
                        <li><a href="index.php#cart">Card</a></li>
                    </ul>
                </li>
...
<section class="home" id="home">
    <div class="content">
        ...
        <a href="index.php#Bouquet" class="btn">Shop now</a><br>
        <p> Don't forget to visit our Nursery | produce and plant quality seedlings to satisfy you.</p>
        <a href="pepiniere.php"class="btn" target="_blank"> Nursery Mas</a>
    </div>
</section>
<!-- home section ends -->
...
<section class="footer">
    <div class="box-container">
        <div class="box">
            ...
            <a href="index.php#Bouquet">BOUQUET</a>
